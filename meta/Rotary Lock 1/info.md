...
The lock will open if you enter a certain code. The code consists of a sequence of M integers, the ith of which is C_i​. Determine the minimum number of seconds required to select all M of the code's integers in order.
